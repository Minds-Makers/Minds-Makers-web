    ...
    <>
      <section className="hero" style={{ padding: '80px 0 60px' }}>
        <div className="container about-hero">
          ...
          <div
            className="synapse-wrap"
            style={{ maxWidth: 340, marginInlineStart: 'auto' }}
          >
            <svg viewBox="0 0 480 480">
              ...
              <circle
                ...
                r="110"
                fill="none"
                stroke="rgba(140,165,255,0.14)"
                strokeWidth="1"
              />

              <path
                className="syn-line"
                style={{ stroke: 'url(#syn-grad2)' }}
                d="M240,90 a150,150 0 0 1 130,75"
              />

              <path
                className="syn-line"
                style={{ stroke: 'url(#syn-grad2)' }}
                d="M110,165 a150,150 0 0 0 0,150"
              />

              <path
                className="syn-line"
                style={{ stroke: 'url(#syn-grad2)' }}
                d="M240,390 a150,150 0 0 0 130,-75"
              />
      ...
      <section className="section section-alt">
        <div className="container">
          ...
          <div className="section-head">
            ...
            <h2>
              {t({
                en: "Three things we won't compromise on.",
                ar: '٣ حاجات مش هنتنازل عنها.'
              })}
            </h2>
          </div>
      ...
      <section className="section">
        <div className="container">
          ...
          <div className="section-head">
            ...
            <h2>
              {t({
                en: 'The people behind the platforms.',
                ar: 'الناس اللي وراء المنصات.'
              })}
            </h2>
      ...
      <section className="section section-alt">
        <div className="container">
          ...
          <div className="cta-band">
            ...
            <h2>
              {t({
                en: 'Want to build something with us?',
                ar: 'عايز تبني حاجة معانا؟'
              })}
            </h2>
