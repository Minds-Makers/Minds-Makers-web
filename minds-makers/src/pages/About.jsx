        ...
        <div className="container about-hero">
          ...
          <div className="synapse-wrap" style={{ maxWidth: 340, marginInlineStart: 'auto' }}>
            <svg viewBox="0 0 480 480">
              ...
              <circle cx="240" cy="240" r="150" fill="none" stroke="rgba(140,165,255,0.18)" />
              <circle cx="240" cy="240" r="110" fill="none" stroke="rgba(140,165,255,0.14)" />
        ...
        <div className="container">
          ...
          <div className="section-head">
            <span className="eyebrow">
              {t({ en: 'How we think', ar: 'إزاي بنفكر' })}
            </span>
